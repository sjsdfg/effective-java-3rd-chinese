...
- [05. 使用依赖注入取代硬连接资源(hardwiring resources)](notes/05.%20使用依赖注入取代硬连接资源(hardwiring%20resources).md)
...
- [19. 如使用继承则设计，应当文档说明，否则不该使用](notes/19.%20如使用继承则设计，应当文档说明，否则不该使用.md)
